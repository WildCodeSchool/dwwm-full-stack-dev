...
namespace App\Tests\PHP\POO\Ex03;
...
final class HouseTest extends WildCodeSchoolTestCase
{
    ...
    {
        include_once __DIR__ . '/../../../../resources/PHP/Tests/testEx03-1.php';
    ...
    {
        $process = new Process(['php', __DIR__ . '/../../../../resources/PHP/Tests/testEx03-2.php']);
        $process->run();
